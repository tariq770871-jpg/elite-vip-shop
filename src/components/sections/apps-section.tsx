            ...
            return (
              <div key={app.id} className="card-3d flex flex-col p-6">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <svg className="size-4 shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.04L13.62 12.6 3.18 2.16c-.12.12-.18.28-.18.46v19.96c0 .18.06.34.18.46zm1.46.96l11.44-6.62-2.52-2.52-8.92 9.14zm0-23.96l8.92 9.14 2.52-2.52L4.64.04zM17.36 9.18l-2.72 1.58 2.72 1.58 3.18-1.58-3.18-1.58zm-2.72 2.8l-2.52 2.52 2.52 2.52 3.18-1.58-3.18-3.46z"/></svg>
                    تنزيل
                  </button>
                  <button
                    className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-sky-500/30 bg-sky-500/10 px-3 py-2.5 text-sm font-semibold text-sky-600 dark:text-sky-400 transition-all hover:bg-sky-500/20"
                    onClick={() => {
                      const w = window.open(`https://t.me/EliteVipShopBot`, "_blank");
                      if (w) w.opener = null;
                    }}
                  >
