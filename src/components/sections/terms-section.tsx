    ...
    <section className="section-gradient-ai py-12 px-4 md:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          {/* Section 4 */}
          <div className="card-3d p-6 md:p-8">
            <h2 className="mb-4 text-xl font-bold">4. الطلبات والدفع</h2>
            <p className="mb-3 leading-8 text-muted-foreground">
              يتم التعامل مع جميع الطلبات والدفعات وفق القواعد التالية:
            </p>
            <ul className="ms-4 list-disc space-y-2 text-muted-foreground">
              <li className="leading-7">يتم تقديم الطلبات عبر واتساب مباشرة بالتواصل مع رقم المتجر، وذلك لضمان سرعة الرد وتأكيد التفاصيل مع العميل.</li>
              <li className="leading-7">يتم تأكيد الطلب بعد الاتفاق على المنتجات والأسعار وطريقة الدفع المناسبة عبر واتساب.</li>
              <li className="leading-7">طرق الدفع المتاحة يتم الاتفاق عليها بين العميل والمتجر عند تقديم الطلب.</li>
              <li className="leading-7">يتم استرجاع المبالغ وفقاً لسياسة الاسترجاع المنشورة على الموقع خلال المهلة المحددة.</li>
              <li className="leading-7">أي محاولات احتيال ستتم إبلاغ الجهات المختصة عنها وقد تؤدي إلى حظر التعامل نهائياً.</li>
            </ul>
          </div>
          ...
          {/* Section 6 */}
          <div className="card-3d p-6 md:p-8">
            <h2 className="mb-4 text-xl font-bold">6. المحتوى المقدم من المستخدمين</h2>
            <p className="leading-8 text-muted-foreground">
