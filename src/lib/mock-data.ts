...
export const appsData: FreeItem[] = [
  {
    ...
    icon: '',
    link: 'https://play.google.com/store/search?q=task+manager+ai',
  },
  {
    id: 'app-2',
    ...
    icon: '',
    link: 'https://play.google.com/store/search?q=photo+editor+pro',
  },
  {
    id: 'app-3',
    title: 'بوت تعلم اللغات',
    description: 'بوت تيليجرام تفاعلي لتعلم اللغات بطريقة ممتعة مع دروس يومية وممارسة المحادثة.',
    icon: '',
    link: 'https://t.me/LanguageLearnBot',
  },
  {
    id: 'app-4',
    ...
    icon: '',
    link: 'https://play.google.com/store/search?q=pdf+scanner+ocr',
  },
  {
    id: 'app-5',
    title: 'بوت اللياقة البدنية',
    description: 'بوت تيليجرام لتمارين شخصية مع متتبع للتمارين والسعرات والماء، يشمل فيديوهات تعليمية.',
    icon: '',
    link: 'https://t.me/FitCoachBot',
  },
  {
    id: 'app-6',
    ...
    icon: '',
    link: 'https://play.google.com/store/search?q=budget+planner+finance',
  },
]
...
export interface FaqItem {
  ...
  question: string
  answer: string
  category: 'عام' | 'طلب' | 'دفع' | 'شحن' | 'خدمات'
}
...
export const faqData: FaqItem[] = [
  ...
  {
    id: 'faq-9',
    question: 'ما هي خدمات التطبيقات والأدوات؟',
    answer: 'نوفر مجموعة متنوعة من التطبيقات والأدوات الذكية تشمل: أدوات تصميم المواقع، أدوات التسويق الرقمي، تطبيقات الذكاء الاصطناعي، وأدوات تحسين الإنتاجية. تصفح القسم لمعرفة المزيد.',
    category: 'عام',
  },
  {
    id: 'faq-10',
    question: 'كيف يمكنني الاستفادة من قسم التداول؟',
    answer: 'قسم التداول يوفر لك تعليم التداول من الصفر، أدوات تحليل فنية، مؤشرات تداول، وشروحات مبسطة. يمكنك التواصل معنا عبر واتساب للحصول على التفاصيل والاشتراك.',
    category: 'عام',
  },
  {
    id: 'faq-11',
    question: 'هل يمكنني طلب خدمة تصميم موقع؟',
    answer: 'نعم! نوفر خدمات تصميم وتطوير المواقع بأسعار تنافسية. زيارة قسم الخدمات لمعرفة التفاصيل أو تواصل معنا مباشرة عبر واتساب لمناقشة مشروعك.',
    category: 'طلب',
  },
  {
    id: 'faq-12',
    question: 'هل الشحن مجاني؟',
    answer: 'نعم، الشحن مجاني للطلبات التي تتجاوز 5,000 ر.ي. للطلبات الأقل يتم حساب رسوم شحن بسيطة حسب المنطقة.',
    category: 'شحن',
  },
  {
    id: 'faq-13',
    question: 'ما هي طرق الربح من الإنترنت المتاحة؟',
    answer: 'نوفر محتوى شامل عن طرق الربح من الإنترنت تشمل: العمل الحر، التسويق بالعمولة، التجارة الإلكترونية، صناعة المحتوى، والكثير. تصفح قسم الربح من الإنترنت للتفاصيل.',
    category: 'عام',
  },
  {
    id: 'faq-14',
    question: 'كيف أتابع طلبي؟',
    answer: 'بمجرد تأكيد طلبك عبر واتساب، سنبقيك على اطلاع بكل مرحلة من مراحل الشحن والتوصيل مباشرة عبر واتساب.',
    category: 'شحن',
  },
  {
    id: 'faq-15',
    question: 'ما هي منتجاتكم الأكثر مبيعاً؟',
    answer: 'منتجاتنا الأكثر مبيعاً تشمل: سماعات بلوتوث فاخرة، ساعات ذكية VIP Series، وملحقات إلكترونية متنوعة. تفضل بزيارة المتجر لاستكشاف جميع المنتجات المتوفرة.',
    category: 'طلب',
  },
  {
    id: 'faq-16',
    question: 'هل يمكنني الحصول على خصم لطلب كميات كبيرة؟',
    answer: 'نعم، نوفر خصومات خاصة للطلبات بالجملة. تواصل معنا عبر واتساب واذكر المنتج والكمية المطلوبة وسنقدم لك أفضل سعر.',
    category: 'دفع',
  },
]
